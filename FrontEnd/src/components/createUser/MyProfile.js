                    ...
                    {this.state.showMessage ? <div id="alertHead" className="alert alert-success " ><h6 className="font-weight-bold">Profile updated Successfully</h6> </div> : null}
                        ...
                        <div style={cardStyle}>
                            ...
                            <div style={containerStyle}>
                                ...
                                <h6  ><b className="h4">{this.state.userBean.employeeId}</b></h6>
                                <h6><b className="h4" >{this.state.employeeNameUpper}</b></h6>

                                <h1 className="h3">{this.state.userBean.email}</h1>
                                <h5 className="h3"> {this.state.userBean.designation}</h5>
                            </div>
                            <hr></hr>
