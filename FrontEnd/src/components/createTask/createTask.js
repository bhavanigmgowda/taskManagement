            ...
            <div id="page-container" >
                <div id="content-wrap">
                    ...
                    <div className="container-fluid ">
                        {this.state.showServerError ? <div id="alertHead" className="alert alert-danger mt-5 " role="alert" ><h6 className="font-weight-bold">Task Creation Failed Server Failed to Respond</h6> </div> : null}
                        {this.state.showEmailDNE ? <div id="alertHead" class="alert alert-danger mt-5"><h6 className="font-weight-bold">Task Creation Failed Email does not Exist!!!</h6> </div> : null}
                        {this.state.showSuccess ? <div id="alertHead" class="alert alert-success mt-5" ><h6 className="font-weight-bold">Task Created Successfully</h6> </div> : null}
                        <div className="row">
